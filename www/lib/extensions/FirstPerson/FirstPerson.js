...
(function() {
    ...
    Autodesk.Viewing.Extensions.FirstPerson.FirstPersonTool = function ( viewerapi ) {
        ...
        this.activate = function(name)
        {
            ...
            _rolloverDisabled = viewerapi.impl.rolloverDisabled;
            viewerapi.impl.disableRollover(true);
        ...
        this.deactivate = function(name)
        {
            ...
            if(!_rolloverDisabled) {
                viewerapi.impl.disableRollover(false);
            }
